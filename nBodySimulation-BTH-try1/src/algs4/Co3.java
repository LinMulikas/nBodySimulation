...
public class Co3{
	...
	//public final double G = 6.67e-11;//把G参数挪到particle类中 传参次数减少 增强可读性
	...
	private void predict(Particle a){
		...
		}//普朗克时间：1/20毫秒。若碰撞事件在普朗克时间内 则将事件插入队列
	...
	public void simulate(double limit){
		...
		while(!pq.isEmpty()){
			...
			else if(a != null){//a非空而b空的情况
				a.bounceOffVerticalWall();
			}  // particle-wall collision
			else if(b != null){//b非空而a空的情况
